...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'logs_log', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Log.date'
        db.alter_column(u'logs_log', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))
