...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'logs_workout', (
            ...
            ('sets', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ...
        db.create_table(u'logs_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        ...
        db.create_table(u'logs_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'logs', ['UserProfile'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'logs_userprofile')
    ...
    models = {
        ...
        u'logs.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logs': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'profile'", 'blank': 'True', 'to': u"orm['logs.Log']"}),
